...
/**
 * button jumping to previous song on playlist
 */
public class BackButton extends JButton {  // Change to JButton to handle clicks
    public BackButton() {
    ...
    protected void paintComponent(Graphics g) {
        ...
        Image image = new ImageIcon("src/main/resources/icons/arrows_circle_right.png").getImage();
